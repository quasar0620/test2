...
def main():
    ...
    dev_path = 'C:\\rsup\\dev'
    data_path = 'C:\\rsup\\data\\apache'
    template_path = os.path.join('C:\\rsup\\templet', 'templet_apache.xlsx')
    result_path = os.path.join('C:\\rsup', 'apache.xlsx')

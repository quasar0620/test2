...
def main():
    ...
    dev_path = 'C:\\rsup\\dev'
    data_path = 'C:\\rsup\\data\\tomcat'
    template_path = os.path.join('C:\\rsup\\templet', 'templet_tomcat.xlsx')
    result_path = os.path.join('C:\\rsup', 'tomcat.xlsx')

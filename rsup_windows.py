...
def main():
    dev_path = 'C:\\rsup\\dev'
    data_path = 'C:\\rsup\\data\\windows'
    template_path = os.path.join('C:\\rsup\\templet', 'templet_windows.xlsx')
    result_path = os.path.join('C:\\rsup', 'windows.xlsx')

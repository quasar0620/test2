...
def main():
    dev_path = 'C:\\rsup\\dev'
    data_path = 'C:\\rsup\\data\\unix'
    template_path = os.path.join('C:\\rsup\\templet', 'templet_unix.xlsx')
    result_path = os.path.join('C:\\rsup', 'unix.xlsx')
